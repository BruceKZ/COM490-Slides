...
\begin{frame}{Validation: Does the Probability Mean What It Says?}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{figures/validation/delay_model_calibration.pdf}
      \caption{higher data coverage than expected}
  \end{columns}
\end{frame}
...
\begin{frame}{Validation Finding: Morning Peak Risk}
  \begin{columns}[T,onlytextwidth]
    \column{0.53\textwidth}
      \centering
      \includegraphics[]{figures/validation/calibration_hour_of_day.png}
...
\begin{frame}{Operational Example}
  \begin{columns}[T,onlytextwidth]
    \column{0.42\textwidth}
      ...
      \vspace{2mm}
        ...
        \begin{tabular}{ccc}
          ...
          dep. & arr. & confidence\\
          \midrule
          \textbf{07:47} & \textbf{08:08} & \textbf{96.6\%}\\
          07:42 & 08:04 & 95.0\%\\
          \bottomrule
        \end{tabular}
      \end{block}
    ...
    \column{0.55\textwidth}
      ...
      \centering
      \resizebox{\textwidth}{!}{\input{figures/examples/operational_route_sketch.tex}}

      \vspace{6mm}
      \begin{tikzpicture}
        \node[draw=muted!40,rounded corners=2pt,inner sep=6pt,
              fill=muted!5,text=ink,font=\footnotesize,align=left,
              text width=0.9\linewidth]
          {\textbf{Selected route} --- confidence \textbf{96.6\%}, no walking.\\
           Transfer slack at Lausanne-Flon: 4 min \\(m1 arr 07:59 $\to$ m2 dep 08:03)\\
           then 3 min at CHUV before the 09:00 deadline.};
      \end{tikzpicture}
  \end{columns}
\end{frame}
